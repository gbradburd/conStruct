...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(49, 47, "end", "model_space_oneK");
    return reader;
}
        ...
        for (int i = 1; i <= N; ++i) {
            ...
            for (int j = i; j <= N; ++j) {
                ...
                stan::model::assign(parCov, 
                            ...
                            (a0 * stan::math::exp(-(pow((aD * get_base1(D, i, j, "D", 1)), a2)))), 
...
class model_space_oneK
  : public stan::model::model_base_crtp<model_space_oneK> {
private:
        int K;
        int N;
        int L;
...
public:
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "alphaD", "double", context__.to_vec());
        double alphaD(0);
