  ...
  try {
    ...
    for (int i = 1; i <= N; ++i) {
      ...
      for (int j = i; j <= N; ++j) {
        ...
        stan::model::assign(cov, ((a0 *
          stan::math::exp(
            -stan::math::pow((aD *
               stan::model::rvalue(D, "D", stan::model::index_uni(i),
                 stan::model::index_uni(j))), a2))) + phi),
          "assigning variable cov", stan::model::index_uni(i),
          stan::model::index_uni(j));
        current_statement__ = 53;
        stan::model::assign(cov,
          stan::model::rvalue(cov, "cov", stan::model::index_uni(i),
            stan::model::index_uni(j)), "assigning variable cov",
...
admixed_covariance(const int& N, const int& K, const T2__& alpha0_arg__,
  ...
  using local_scalar_t__ = stan::promote_args_t<stan::base_type_t<T2__>,
                             ...
                             stan::promote_args_t<stan::base_type_t<T7__>,
                               stan::base_type_t<T8__>, T9__>>;
  int current_statement__ = 0;
  const auto& alpha0 = stan::math::to_ref(alpha0_arg__);
  const auto& alphaD = stan::math::to_ref(alphaD_arg__);
  const auto& alpha2 = stan::math::to_ref(alpha2_arg__);
  const auto& geoDist = stan::math::to_ref(geoDist_arg__);
      ...
      stan::model::assign(parCov,
        stan::math::add(stan::model::deep_copy(parCov),
          stan::math::elt_multiply(
            ...
            spCov(N,
              stan::model::rvalue(alpha0, "alpha0", stan::model::index_uni(k)),
              stan::model::rvalue(alphaD, "alphaD", stan::model::index_uni(k)),
              stan::model::rvalue(alpha2, "alpha2", stan::model::index_uni(k)),
              geoDist,
              stan::model::rvalue(phi, "phi", stan::model::index_uni(k)),
              pstream__))), "assigning variable parCov");
    }
...
public:
  ~model_space_multiK() {}
  model_space_multiK(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_space_multiK_namespace::model_space_multiK";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
    ...
    try {
      ...
      stan::math::validate_non_negative_index("alpha0", "K", K);
      current_statement__ = 39;
      stan::math::validate_non_negative_index("alphaD", "K", K);
      current_statement__ = 40;
      stan::math::validate_non_negative_index("alpha2", "K", K);
    ...
    num_params_r__ = K + K + K + K + N + (N * (K - 1)) + 1;
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_space_multiK_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      alpha0 = in__.template read_constrain_lb<
                 Eigen::Matrix<local_scalar_t__,-1,1>, jacobian__>(0, lp__,
                 K);
      Eigen::Matrix<local_scalar_t__,-1,1> alphaD =
        Eigen::Matrix<local_scalar_t__,-1,1>::Constant(K, DUMMY_VAR__);
      current_statement__ = 2;
      alphaD = in__.template read_constrain_lb<
                 Eigen::Matrix<local_scalar_t__,-1,1>, jacobian__>(0, lp__,
                 K);
      Eigen::Matrix<local_scalar_t__,-1,1> alpha2 =
        Eigen::Matrix<local_scalar_t__,-1,1>::Constant(K, DUMMY_VAR__);
      current_statement__ = 3;
      alpha2 = in__.template read_constrain_lub<
                 Eigen::Matrix<local_scalar_t__,-1,1>, jacobian__>(0, 2,
                 lp__, K);
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_space_multiK_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  transform_inits_impl(const stan::io::var_context& context__, VecVar&
    ...
    try {
        ...
        Eigen::Matrix<local_scalar_t__,-1,1>::Constant(K, DUMMY_VAR__);
      {
        ...
        current_statement__ = 2;
        alphaD_flat__ = context__.vals_r("alphaD");
        current_statement__ = 2;
        pos__ = 1;
        current_statement__ = 2;
        for (int sym1__ = 1; sym1__ <= K; ++sym1__) {
          current_statement__ = 2;
          stan::model::assign(alphaD, alphaD_flat__[(pos__ - 1)],
            "assigning variable alphaD", stan::model::index_uni(sym1__));
          current_statement__ = 2;
          pos__ = (pos__ + 1);
        }
      }
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"alpha0", "alphaD", "alpha2", "phi",
                "nugget", "w", "gamma"};
    if (emit_transformed_parameters__) {
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"alpha0\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "},\"block\":\"parameters\"},{\"name\":\"alphaD\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "},\"block\":\"parameters\"},{\"name\":\"alpha2\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "},\"block\":\"parameters\"},{\"name\":\"phi\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "},\"block\":\"parameters\"},{\"name\":\"nugget\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"parameters\"},{\"name\":\"w\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(N) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "}},\"block\":\"parameters\"},{\"name\":\"gamma\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"parCov\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(N) + ",\"cols\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"w_mat\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(N) + ",\"cols\":" + std::to_string(K) + "},\"block\":\"transformed_parameters\"}]");
  }
  inline std::string get_unconstrained_sizedtypes() const {
    return std::string("[{\"name\":\"alpha0\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "},\"block\":\"parameters\"},{\"name\":\"alphaD\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "},\"block\":\"parameters\"},{\"name\":\"alpha2\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "},\"block\":\"parameters\"},{\"name\":\"phi\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "},\"block\":\"parameters\"},{\"name\":\"nugget\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"parameters\"},{\"name\":\"w\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(N) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string((K -1)) + "}},\"block\":\"parameters\"},{\"name\":\"gamma\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"parCov\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(N) + ",\"cols\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"w_mat\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(N) + ",\"cols\":" + std::to_string(K) + "},\"block\":\"transformed_parameters\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = ((((((K + K) + K) + K) + N) + (N * K)) + 1);
