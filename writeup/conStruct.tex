...
However, overall, the behavior of both methods is quite similar: 
each recovers the \tri{}/\bals{} split with the first two clusters modeled, 
then, with higher values of $K$, 
uses subsequent clusters to subdivide the \tri{} samples 
...
\begin{figure}
	...
	and the nonspatial \texttt{conStruct} model (right) for $K=3$.
