...
multi-modality in the likelihood surfaces, or 
to differences in the specifics of model 
...
And, both nonspatial \texttt{conStruct} and ADMIXTURE 
...
and appears to describe patterns of isolation by distance between
demes within \tri{} quite well.
...
which affects covariance between individuals within demes, 
but has limited impact on covariance between demes.
...
This discrepancy may be the result of differences in the cross-validation procedures 
implemented in \texttt{conStruct} and ADMIXTURE, 
or perhaps in the ways each accommodate missing data.
