...
by delineating discrete populations from which individuals or alleles are sampled \ref{Wright 1949}.
...
including generating population phylogenies \ref{cavalli-sforza, treemix},
$k$-means clustering analyses performed on dimensionality-reduction approaches \ref{}, 
such as principal components analysis \ref{Cavalli-sforza,Novembre and Stephens, Patterson2006},
and model-based clustering approaches \ref{Pritchard2000, all the other structure papers, admixture, structurama, BAPS, }, among others.
These methods each perform best under different specific demographic histories of samples being analyzed,
but all can give misleading results when applied to data that show a continuous pattern of isolation by distance \ref{Wright 1938, 1940, 1943}.
...
continuous and discrete patterns of genetic differentiation.  
  By introducing a statistical framework that simultaneously 
