...
(for ``\emph{con}tinuous \emph{struct}ure") that functions as a wrapper around this inference machinery.
...
we also analyzed empirical population genomic data from two systems:
