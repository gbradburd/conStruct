...
\begin{figure}
	\centering
		{\includegraphics[width=6in,height=4in]{figs/populus/Fig4_pop_sp_results.pdf}}
	\caption{
...
\gb{The results of the nonspatial analysis differed from those of the fastSTRUCTURE runs (Fig \ref{populus_fastStr}), 
although both showcased the tendency of nonspatial models to describe continuous variation with multiple clusters.
Replicate runs of the nonspatial \texttt{conStruct} model produced different results, 
evidence of multimodality in the likelihood surface, 
which we might expect given the poor correspondence of the model to the data.}
