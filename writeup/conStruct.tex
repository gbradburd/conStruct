...
and avoids problems with overfitting that nonspatial models are prone to.
...
in particular, $\P\{X_i = 1\} = 1$, so $\widehat{\Omega}_{i,i} = 1/4$ for every $i$ --
...
$\widehat \Omega$, can be calculated as a covariance
