...
Another way to describe how additional layers contribute to model fit
...
encouraging the model to ``not use" unnecessary layers, 
so that they will have a low contribution to overall covariance.
We use the connection of allelic covariance to the probability of agreement (identity) between genotypes
to calculate a measure of overall contribution of each layer to the model.
XXX PLR XXX
To calculate the overall contribution of the $k$th layer to the model,
we use the connection between allelic covariance and 
...
with the number of layers in the model, 
...
in contrast, additional clusters in the nonspatial analyses continue to
