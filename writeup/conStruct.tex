...
computational speed.)
\gc{The second small difference is that in the original STRUCTURE model,
  allele frequencies at each locus are independently drawn for each
  cluster \citep{STRUCTURE}, while in conStruct's non-spatial model,
  it is more natural to envision each layer's allele frequency
