...
and remedies the overfitting that nonspatial models are prone to.
...
as shown in Fig \ref{sim_xvals} (vermilion points),
...
\begin{figure}
    ...
    The ADMIXTURE model with the lowest cross-validation error 
    (i.e., the preferred model) is highlighted with an vermilion diamond.
...
and so the parameters estimated from the training partition 
...
or near to on the genome, loci in the testing dataset.
