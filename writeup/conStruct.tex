...
i.e., the mean density of sites at which random samples from $i$ and $j$ differ.
...
or via thermodynamic integration \cite{verity_nichols2016};
...
but has limited impact on covariance between locations. \revpoint{1}{5}
...
First, covariance between Eastern bears falls off gradually rather than abruptly with distance,
